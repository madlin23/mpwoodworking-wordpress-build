...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-[#010101]">
    <!-- Back-Link -->
    <a href="<?php echo get_post_type_archive_link('projekt'); ?>" class="inline-flex items-center space-x-2 text-xs tracking-wider uppercase text-[#a8a8a3] hover:text-[#008b1d] mb-12 font-sans font-bold group transition-colors">
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div class="lg:col-span-7 flex flex-col space-y-6">
                <div class="aspect-[16/10] w-full overflow-hidden bg-[#1a1a19] border border-[#2a2a28] hover:border-[#008b1d]/30 transition-colors">
                ...
                ?>
                    <div class="grid grid-cols-2 gap-6">
                        <?php foreach ( $gallery_attachment_ids as $id ) : ?>
                            <div class="aspect-[16/10] overflow-hidden bg-[#1a1a19] border border-[#2a2a28] hover:border-[#008b1d]/30 transition-colors">
            ...
            <div class="lg:col-span-5 flex flex-col space-y-8 relative pl-6">
                ...
                <div class="flex flex-col space-y-3">
                    <span class="text-xs tracking-[0.3em] text-[#d40924] uppercase font-bold font-sans flex items-center gap-1.5">
                        ...
                        <span class="w-1.5 h-1.5 rounded-full bg-[#008b1d] inline-block shadow-[0_0_4px_#008b1d]"></span>
                    </span>
                    ...
                    <div class="h-[1px] bg-[#2a2a28] w-full pt-2 relative">
                        <div class="absolute bottom-0 left-0 w-12 h-[1px] bg-[#008b1d]/50"></div>
                    </div>
                </div>
                ...
                <?php if ( function_exists('get_field') ) : ?>
                    <div class="bg-[#11110f] p-6 border border-[#2a2a28] hover:border-[#008b1d]/20 transition-colors flex flex-col space-y-6 relative group">
                        <!-- Feiner grüner Glimm-Streifen über der ACF Box im Hover -->
                        <div class="absolute top-0 left-6 right-6 h-[1px] bg-[#008b1d]/0 group-hover:bg-[#008b1d]/30 transition-colors" />
                        ...
                        <?php if ( get_field('holzart_detail') ) : ?>
                            <div class="flex items-start space-x-3 group/item">
                                <div class="p-2 bg-[#010101] border border-[#2a2a28] group-hover/item:border-[#008b1d]/40 mt-0.5 text-[#d40924] group-hover/item:text-[#008b1d] transition-colors">
                                    <!-- Sparkles Icon -->
        ...
        <section class="py-16 bg-[#010101] border-t border-[#2a2a28]">
            <div class="container max-w-6xl mx-auto px-4">
                <div class="flex flex-col space-y-3 mb-10 relative pl-4">
                    <div class="absolute left-0 top-0 bottom-0 w-[3px] bg-[#008b1d]"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php foreach ( $verknuepfte_produkte as $produkt ) : ?>
                        <a href="<?php echo get_permalink( $produkt->ID ); ?>" class="group flex flex-col space-y-3 p-4 bg-[#11110f] border border-[#2a2a28] hover:border-[#008b1d]/40 transition-colors no-underline">
                            ...
                            <?php endif; ?>
                            <div class="flex flex-col space-y-1">
                                <h3 class="font-serif text-lg font-black uppercase text-[#f8f8f7] group-hover:text-[#008b1d] transition-colors">
                                ...
                                if ( $product_obj ) : ?>
                                    <span class="font-serif text-base font-bold text-[#d40924] flex items-center gap-1.5">
                                        ...
                                        <span class="w-1.5 h-1.5 rounded-full bg-[#008b1d] inline-block" style="box-shadow: 0 0 6px #008b1d;"></span>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </a>
