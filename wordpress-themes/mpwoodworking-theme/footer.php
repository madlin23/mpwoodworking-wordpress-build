    ...
    <!-- Footer -->
    <footer class="bg-[#11110f] text-[#f8f8f7] mt-20 border-t border-[#2a2a28] hover:border-t-[#008b1d]/20 transition-colors relative">
        {/* Feiner grüner Glimm-Streifen über dem Footer */}
        <div class="absolute top-0 left-0 w-full h-[1px] bg-[#008b1d]/10" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div class="flex items-center space-x-2 text-[10px] tracking-widest text-[#d40924] uppercase pt-2 font-bold group">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3 text-[#d40924] group-hover:text-[#008b1d] transition-colors">
