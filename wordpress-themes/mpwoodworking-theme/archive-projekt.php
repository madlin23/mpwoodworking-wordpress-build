...
<section class="bg-[#11110f] border-b border-[#2a2a28] py-16 relative">
    ...
    <div class="absolute bottom-0 left-0 w-full h-[1px] bg-[#008b1d]/30" />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl flex flex-col space-y-4 relative pl-4">
            ...
            <div class="absolute left-0 top-0 bottom-0 w-[3px] bg-[#008b1d]" />
        ...
        <?php if ( have_posts() ) : ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                <?php while ( have_posts() ) : the_post(); ?>
                    <div class="group flex flex-col space-y-4 border border-[#2a2a28] p-4 bg-[#11110f] hover:border-[#008b1d]/40 transition-colors relative">
                        <!-- Feiner grüner Glimm-Streifen über dem Projekt-Panel im Hover -->
                        <div class="absolute top-0 left-4 right-4 h-[1px] bg-[#008b1d]/0 group-hover:bg-[#008b1d]/30 transition-colors" />
                        ...
                        <div class="flex flex-col space-y-2 pt-2">
                            <h3 class="font-serif text-2xl font-black uppercase text-[#f8f8f7] group-hover:text-[#008b1d] transition-colors">
                                <?php the_title(); ?>
                            </h3>
                        ...
                        <div class="pt-2">
                            <a href="<?php the_permalink(); ?>">
                                <span class="text-xs tracking-wider uppercase font-bold text-[#f8f8f7] group-hover:text-[#008b1d] flex items-center space-x-1 font-sans">
