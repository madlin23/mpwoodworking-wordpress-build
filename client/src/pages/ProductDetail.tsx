      ...
      <div className="container py-8 bg-[#010101]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-4">
            <div className="aspect-square w-full overflow-hidden bg-[#1a1a19] border border-[#2a2a28] hover:border-[#008b1d]/40 transition-colors relative group">
            ...
            {product.gallery.length > 0 && (
              <div className="grid grid-cols-3 gap-4">
                {product.gallery.map((img, idx) => (
                  <div key={idx} className="aspect-square overflow-hidden bg-[#1a1a19] border border-[#2a2a28] hover:border-[#008b1d]/40 transition-colors relative group">
                    <img
                      src={img}
          ...
          <div className="lg:col-span-5 flex flex-col space-y-8 relative pl-6">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex items-center justify-between pt-2 border-b border-[#2a2a28] pb-4">
                ...
                <span className="font-serif text-3xl font-bold text-[#d40924] flex items-center gap-2">
                  ...
                  <span className="w-2 h-2 rounded-full bg-[#008b1d] inline-block shadow-[0_0_8px_#008b1d]" />
                </span>
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center space-x-4">
                <div className="flex items-center border border-[#2a2a28] bg-[#11110f]">
                  <button
                    ...
                    className="px-4 py-3 hover:bg-[#1a1a19] hover:text-[#008b1d] transition-colors font-sans text-sm text-[#f8f8f7]"
                  >
                    -
                  </button>
                ...
                <Button
                  ...
                  className="flex-grow bg-[#d40924] hover:bg-[#ef1a35] text-[#f8f8f7] border border-transparent font-sans uppercase tracking-wider text-xs py-6 rounded-none cursor-pointer flex items-center justify-center space-x-2 font-bold transition-all hover:shadow-[0_0_15px_rgba(0, 139, 29, 0.3)] hover:border-[#008b1d]/40"
                >
              ...
              <span className="text-xs text-[#d40924] font-sans font-bold flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#008b1d] inline-block" />
            ...
            <div className="border-t border-[#2a2a28] pt-6 grid grid-cols-3 gap-4 text-center">
              <div className="flex flex-col items-center space-y-1 group">
                <ShieldCheck className="w-5 h-5 text-[#d40924] group-hover:text-[#008b1d] stroke-[1.5] transition-colors" />
                <span className="text-[10px] font-sans font-bold uppercase tracking-wider text-[#f8f8f7]">Unikat-Garantie</span>
              </div>
              <div className="flex flex-col items-center space-y-1 group">
                <Truck className="w-5 h-5 text-[#d40924] group-hover:text-[#008b1d] stroke-[1.5] transition-colors" />
                <span className="text-[10px] font-sans font-bold uppercase tracking-wider text-[#f8f8f7]">Kostenloser Versand</span>
              </div>
              <div className="flex flex-col items-center space-y-1 group">
                <RefreshCw className="w-5 h-5 text-[#d40924] group-hover:text-[#008b1d] stroke-[1.5] transition-colors" />
