      ...
      <div className="container py-8 bg-[#010101]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-4">
            <div className="aspect-square w-full overflow-hidden bg-[#1a1a19] border border-[#2a2a28]">
              <img
                src={product.image}
                alt={product.title}
            ...
            {product.gallery.length > 0 && (
              <div className="grid grid-cols-3 gap-4">
                {product.gallery.map((img, idx) => (
                  <div key={idx} className="aspect-square overflow-hidden bg-[#1a1a19] border border-[#2a2a28]">
                    <img
                      src={img}
          ...
          <div className="lg:col-span-5 flex flex-col space-y-8">
            <div className="flex flex-col space-y-3">
              <span className="text-xs tracking-[0.25em] text-[#d40924] uppercase font-sans font-bold">
              ...
              <div className="flex items-center justify-between pt-2 border-b border-[#2a2a28] pb-4">
                <span className="font-serif text-3xl font-bold text-[#d40924]">
            ...
            <div className="bg-[#11110f] p-6 border border-[#2a2a28]">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center border border-[#2a2a28] bg-[#11110f]">
                  <button
                    ...
                    className="px-4 py-3 hover:bg-[#1a1a19] transition-colors font-sans text-sm text-[#f8f8f7]"
                  >
                    -
                  </button>
                ...
                <Button
                  ...
                  className="flex-grow bg-[#d40924] hover:bg-[#ef1a35] text-[#f8f8f7] border border-transparent font-sans uppercase tracking-wider text-xs py-6 rounded-none cursor-pointer flex items-center justify-center space-x-2 font-bold"
                >
                  <ShoppingBag className="w-4 h-4" />
                  <span>In den Warenkorb</span>
                </Button>
              </div>
              <span className="text-xs text-[#d40924] font-sans font-bold">
