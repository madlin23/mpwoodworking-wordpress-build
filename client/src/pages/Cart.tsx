      ...
      <div className="container py-16 bg-[#010101]">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20 border border-dashed border-[#2a2a28] flex flex-col items-center justify-center space-y-4 bg-[#11110f] relative group">
            ...
            <div className="absolute inset-x-12 top-0 h-[1px] bg-[#a3e635]/20" />
            
            <div className="p-4 bg-[#1a1a19] text-[#d40924] group-hover:text-[#a3e635] transition-colors border border-[#2a2a28] group-hover:border-[#a3e635]/30">
            ...
            <Link href="/shop">
              <Button className="bg-[#d40924] hover:bg-[#ef1a35] text-[#f8f8f7] border border-transparent font-sans uppercase tracking-wider text-xs py-4 px-6 rounded-none cursor-pointer mt-2 font-bold transition-all hover:shadow-[0_0_15px_rgba(163,230,53,0.3)] hover:border-[#a3e635]/40">
                Zum Shop
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 flex flex-col space-y-6">
              {items.map((item) => (
                <div
                  key={item.product.id}
                  className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border border-[#2a2a28] hover:border-[#a3e635]/20 bg-[#11110f] gap-4 transition-colors relative group"
                >
                  {/* Feiner grüner Glimm-Streifen über dem Artikel im Hover */}
                  <div className="absolute top-0 left-4 right-4 h-[1px] bg-[#a3e635]/0 group-hover:bg-[#a3e635]/20 transition-colors" />

                  {/* Bild & Titel */}
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-16 bg-[#1a1a19] overflow-hidden border border-[#2a2a28] group-hover:border-[#a3e635]/30 flex-shrink-0 transition-colors">
                      <img
                    ...
                    <div className="flex flex-col">
                      <Link href={`/produkt/${item.product.slug}`}>
                        <span className="font-serif text-xl font-black uppercase hover:text-[#a3e635] cursor-pointer text-[#f8f8f7] transition-colors flex items-center gap-1.5">
                          {item.product.title}
                        </span>
                      </Link>
                      <span className="text-[10px] text-[#a8a8a3] font-sans uppercase font-bold tracking-wider mt-0.5 flex items-center gap-1.5">
                        ...
                        <span className="w-1 h-1 rounded-full bg-[#a3e635]/40 inline-block"></span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-8 border-t sm:border-t-0 border-[#2a2a28] pt-4 sm:pt-0">
                    {/* Mengenauswahl */}
                    <div className="flex items-center border border-[#2a2a28] bg-[#010101] group-hover:border-[#a3e635]/30 transition-colors">
                      <button
                        onClick={() => updateQuantity(item.product.id, item.quantity - 1)}
                        className="px-3 py-1 hover:bg-[#11110f] hover:text-[#a3e635] transition-colors font-sans text-xs text-[#f8f8f7]"
                      >
                        -
                      </button>
            ...
            {/* Zusammenfassung */}
            <div className="lg:col-span-4 bg-[#11110f] p-6 border border-[#2a2a28] hover:border-[#a3e635]/20 transition-colors flex flex-col space-y-6 h-fit relative group">
              ...
              <Link href="/kasse">
                <Button className="w-full bg-[#d40924] hover:bg-[#ef1a35] text-[#f8f8f7] border border-transparent font-sans uppercase tracking-wider text-xs py-5 rounded-none cursor-pointer flex items-center justify-center space-x-2 font-bold transition-all hover:shadow-[0_0_15px_rgba(163,230,53,0.3)] hover:border-[#a3e635]/40">
                  <span>Zur Kasse</span>
